...
class InputFactory(FusionEventHandler):
  ...
  def create_float_input(self, id, name, initial_value=0, min=-2147483648, max=2147483647, tooltip='', description='', help_image=None, on_change=None, on_validate=None, persist=True):
    on_eval = lambda __ipt: float(__ipt.value)
