# renders phone stand backplate in 4 seconds
...
class DxfForLaserAddin(fission.CommandBase):
  ...
  def generate_offset_sketch(self, is_preview):
    ...
    for loop in face.loops:
      ...
      assert abs(lead_vector.z) < fission.SketchHelper.CLOSE_ENOUGH, 'expected edge-tangent vector to lay on sketch plane, but it did not!'
